...
describe('StatusDashboard.vue', () => {
  ...
  describe('Initial State', () => {
    ...
    it('should initialize with 5 second refresh interval', () => {
      expect(wrapper.vm.autoRefreshInterval).toBe(5);
    });

    it('should have 15 agents in roster', () => {
  ...
  describe('Auto-Refresh', () => {
    it('should have auto-refresh enabled on mount', () => {
  ...
  describe('Manual Refresh', () => {
    ...
    it('should show loading text during refresh', async () => {
      ...
      // Verify loading state is cleared after async operation
      expect(wrapper.vm.isLoading).toBe(false);
    });
  });
